---
permalink: /
title: "Yingming Mao (茅英明)"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
---
I am a Ph.D. student at **Xi'an Jiaotong University (XJTU)** and **Shanghai Innovation Institute (SII)**, majoring in Control Science and Engineering with a focus on **AI Infrastructure**. My research lies at the intersection of large-scale network optimization and intelligent power systems.
...
* 🔍 **Data Center Networks (DCN):** Traffic Engineering (TE) and Topology Engineering in large-scale and reconfigurable networks.
* 📊 **Microgrid Management:** Optimal scheduling and planning for microgrids with high-penetration renewable energy.
* 💡 **Power System Analysis:** Linear power flow modeling and data generation considering spatial correlations.
...
1. Ximeng Liu, **Yingming Mao**, Zhuoran Liu, Jinhui Ren, Shuyao Qi, Xinchi Han, Siyuan Feng, Peirui Cao, Yatao Li, Shizhen Zhao, and Xinbing Wang. "**AICCL: Pushing the Quality-Scalability-Flexibility Frontier in Collective Communication via Learning.**" *Accepted by NSDI '27*, 2026.
2. Xinchi Han, Weihao Jiang, **Yingming Mao**, Yike Liu, Zhuoran Liu, Yongxi Lv, Peirui Cao, Zhuotao Liu, Ximeng Liu, Xinbing Wang, Changbo Wu, Zihan Zhu, Dongchao Wu, Jian Yang, Zhanbang Zhang, Yuansen Chen, and Shizhen Zhao. "**Avoid Routing Polarization for OCS-based GPU Clusters.**" *Journal of Optical Communications and Networking*, 2026. [[Preprint]](https://arxiv.org/abs/2603.28168)
3. **Yingming Mao**, Ximeng Liu, Jingyi Cheng, Xiyuan Liu, Jiashuai Liu, Yike Liu, Zhen Yao, Yuzhou Zhou, Siyuan Feng, Qiaozhu Zhai, and Shizhen Zhao. "**NeuroRisk: Physics-Informed Neural Optimization for Risk-Aware Traffic Engineering.**" *arXiv preprint arXiv:2605.12862*, 2026. [[Link]](https://arxiv.org/abs/2605.12862)
4. **Yingming Mao**, Qiaozhu Zhai, Ximeng Liu, Zhen Yao, Xia Zhu, and Yuzhou Zhou. "**A Fast Solver-Free Algorithm for Traffic Engineering in Large-Scale Data Center Network.**" *23rd USENIX Symposium on Networked Systems Design and Implementation (NSDI '26)*, 2026. [[Paper]](https://www.usenix.org/conference/nsdi26/presentation/mao)
5. **Yingming Mao**, Qiaozhu Zhai, Ximeng Liu, Xinchi Han, Fafan Li, Shizhen Zhao, Yuzhou Zhou, Zhen Yao, and Xia Zhu. "**ATRO: A Fast Algorithm for Topology Engineering of Reconfigurable Datacenter Networks.**" *Accepted by INFOCOM '26*, 2025. [[Preprint]](https://arxiv.org/abs/2507.13717)
6. Ximeng Liu, Zhuoran Liu, **Yingming Mao**, Yatao Li, Shizhen Zhao, and Xinbing Wang. "**Geminet: Learning the Duality-based Topology-Agnostic Update Operator for Lightweight Traffic Engineering in Changing Topologies.**" *23rd USENIX Symposium on Networked Systems Design and Implementation (NSDI '26)*, 2026. [[Paper]](https://www.usenix.org/conference/nsdi26/presentation/liu-ximeng)
...
* **Outstanding Undergraduate Graduation Design/Thesis**, Shaanxi Province, 2022

## Contact

* **Email:** [maoyingming@sii.edu.cn](mailto:maoyingming@sii.edu.cn)
* **GitHub:** [Yingming-Mao](https://github.com/Yingming-Mao)
* **Location:** Shanghai / Xi'an, China
